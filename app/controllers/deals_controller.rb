class DealsController < ApplicationController
  ...
  def create
    ...
    if @new_deal.save
      deal_created = Deal.find(@new_deal.id)
      receiver_library = UserLibrary.find(params[:receiver_library_id])
      ...
      new_deal_content = DealContent.create(sender_library_id: sender_library.id, receiver_library_id: receiver_library.id, deal_id: deal_created.id)
      ####
